...
import static com.hellothomas.tinyurl.common.enums.ErrorCodeEnum.URL_ADDRESS_INVALID;
...
public class TinyUrlService {
     ...
     * @return com.hellothomas.tinyurl.api.dto.TinyUrlCreateResponse
     * @throws
     */
    ...
    public String getOriginUrl(String tinyUrlStr) {
        if (!tinyUrlStr.startsWith(address)) {
            throw new MyException(URL_ADDRESS_INVALID);
        }
